...
NET=(imagenet32)
NUMCLASSES=(10 25 50 100 250)

for attack in "${ATTACKS[@]}"; do
  echo "ATTACKS: $attack"
done

python -u detect_adversarials_imagenet32.py --detector LayerMFS --num_classes 250 --clf LR --net imagenet32 --attack fgsm 
python -u detect_adversarials_imagenet32.py --detector LayerMFS --num_classes 250 --clf LR --net imagenet32 --attack bim
python -u detect_adversarials_imagenet32.py --detector LayerMFS --num_classes 250 --clf LR --net imagenet32 --attack pgd
python -u detect_adversarials_imagenet32.py --detector LayerMFS --num_classes 250 --clf LR --net imagenet32 --attack df
python -u detect_adversarials_imagenet32.py --detector LayerMFS --num_classes 250 --clf LR --net imagenet32 --attack cw

echo "WB RF #############################################################################"

python -u detect_adversarials_imagenet32.py --detector LayerMFS --num_classes 250 --clf RF --net imagenet32 --attack fgsm 
python -u detect_adversarials_imagenet32.py --detector LayerMFS --num_classes 250 --clf RF --net imagenet32 --attack bim
python -u detect_adversarials_imagenet32.py --detector LayerMFS --num_classes 250 --clf RF --net imagenet32 --attack pgd
python -u detect_adversarials_imagenet32.py --detector LayerMFS --num_classes 250 --clf RF --net imagenet32 --attack df
python -u detect_adversarials_imagenet32.py --detector LayerMFS --num_classes 250 --clf RF --net imagenet32 --attack cw


# echo "BB LR #############################################################################"

# python -u detect_adversarials_imagenet32.py --detector InputMFS --num_classes 250 --clf LR --net imagenet32 --attack fgsm 
# python -u detect_adversarials_imagenet32.py --detector InputMFS --num_classes 250 --clf LR --net imagenet32 --attack bim
# python -u detect_adversarials_imagenet32.py --detector InputMFS --num_classes 250 --clf LR --net imagenet32 --attack pgd
# python -u detect_adversarials_imagenet32.py --detector InputMFS --num_classes 250 --clf LR --net imagenet32 --attack df
# python -u detect_adversarials_imagenet32.py --detector InputMFS --num_classes 250 --clf LR --net imagenet32 --attack cw

# echo "BB RF #############################################################################"

# python -u detect_adversarials_imagenet32.py --detector InputMFS --num_classes 250 --clf RF --net imagenet32 --attack fgsm 
# python -u detect_adversarials_imagenet32.py --detector InputMFS --num_classes 250 --clf RF --net imagenet32 --attack bim
# python -u detect_adversarials_imagenet32.py --detector InputMFS --num_classes 250 --clf RF --net imagenet32 --attack pgd
# python -u detect_adversarials_imagenet32.py --detector InputMFS --num_classes 250 --clf RF --net imagenet32 --attack df
# python -u detect_adversarials_imagenet32.py --detector InputMFS --num_classes 250 --clf RF --net imagenet32 --attack cw
