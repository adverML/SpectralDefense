...
parser.add_argument("--attack",      default='cw', help="the attack method which created the adversarial examples you want to use. Either fgsm, bim, pgd, df or cw")
parser.add_argument("--attack_test", default='std', help="the attack method which created the adversarial examples you want to use. Either fgsm, bim, pgd, df or cw")
...
if attack_method == 'apgd-ce':
...
elif attack_test == 'std':
    print("args eps: ", args.eps_test)
    if args.detector == 'LayerMFS':
        if args.eps_test >= 0.03137254901960780:

            if args.net == 'cif10':
                images_path =      '/home/lorenzp/adversialml/src/src/data/characteristics/cif10/std/cif10_std_LayerMFS_6000_eps_0.031373.p'
                images_advs_path = '/home/lorenzp/adversialml/src/src/data/characteristics/cif10/std/cif10_std_LayerMFS_6000_eps_0.031373_adv.p'
        ...
        if args.eps_test >= 0.03137254901960780:
            ...
            if args.net == 'cif10':
                images_path =      '/home/lorenzp/adversialml/src/src/data/characteristics/cif10/std/cif10_std_InputMFS_6000_eps_0.031373.p'
                images_advs_path = '/home/lorenzp/adversialml/src/src/data/characteristics/cif10/std/cif10_std_InputMFS_6000_eps_0.031373_adv.p'
            elif args.img_size == 32:
                images_path =      '/home/lorenzp/adversialml/src/src/data/characteristics/imagenet32/std/imagenet32_std_InputMFS_6000_eps_0.031373.p'
                images_advs_path = '/home/lorenzp/adversialml/src/src/data/characteristics/imagenet32/std/imagenet32_std_InputMFS_6000_eps_0.031373_adv.p'
            elif args.img_size == 64:
    ...
    path = './data/characteristics/' + net + '/' + net + '_' + attack_test + '_' + detector
