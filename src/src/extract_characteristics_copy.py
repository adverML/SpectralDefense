...
if args.attack == 'apgd-ce' or args.attack == 'apgd-t' or args.attack == 'fab-t' or args.attack == 'square':
    images =      torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/" + args.attack + "_individ_0.03137_Linf_orig")
    images_advs = torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/" + args.attack + "_individ_0.03137_Linf_pert")
    ...
    images_path =      './data/' + net + '_adversarial_images/' + net + '_images_'    + args.attack + appendix
    images_advs_path = './data/' + net + '_adversarial_images/' + net + '_images_adv_'+ args.attack + appendix
...
def calculate_fourier_spectrum(im, typ='MFS'):
    ...
    if net == 'cif100' and (args.attack=='cw' or args.attack=='df'):
...
if args.attack == 'apgd-ce' or args.attack == 'apgd-t' or args.attack == 'fab-t' or args.attack == 'square':
    filename = './data/characteristics/0.03137/' + net + '/ind/' + net + '_' + args.attack + '_' + detector
elif args.attack == 'std':
    path_dir = './data/characteristics/' + net + '/std/'
    filename = path_dir + net + '_' + args.attack + '_' + detector + '_{}_eps_{:5f}'.format(nr_samples, args.eps)
    if not args.nr == -1:
        filename = filename + '_' + layer_name[layer_nr]
elif not args.nr == -1:
    path_dir = './data/characteristics/' + net + '/'
    filename = path_dir + net + '_' + args.attack + '_' + detector+'_'+layer_name[layer_nr]
else:
    path_dir = './data/characteristics/' + net + '/'
    filename = path_dir + net + '_' + args.attack + '_' + detector
