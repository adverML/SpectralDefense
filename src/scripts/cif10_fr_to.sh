...
python -u extract_characteristics.py --net "cif10" --attack "std" --detector "InputMFSAnalysis"  --run_nr "1"  --wanted_samples "$WANTEDSAMPLES" --take_inputimage_off  --fr 0 --to 8
python -u detect_adversarials.py --net "cif10" --attack "std" --detector "InputMFSAnalysis" --wanted_samples "2000" --clf "RF" --num_classes 10  --run_nr "1" 



python -u extract_characteristics.py --net "cif10" --attack "std" --detector "InputMFSAnalysis"  --run_nr "1"  --wanted_samples "$WANTEDSAMPLES" --take_inputimage_off  --fr 0 --to 16
python -u detect_adversarials.py --net "cif10" --attack "std" --detector "InputMFSAnalysis" --wanted_samples "2000" --clf "RF" --num_classes 10  --run_nr "1" 



python -u extract_characteristics.py --net "cif10" --attack "std" --detector "InputMFSAnalysis"  --run_nr "1"  --wanted_samples "$WANTEDSAMPLES" --take_inputimage_off  --fr 0 --to 24
python -u detect_adversarials.py --net "cif10" --attack "std" --detector "InputMFSAnalysis" --wanted_samples "2000" --clf "RF" --num_classes 10  --run_nr "1" 


python -u extract_characteristics.py --net "cif10" --attack "std" --detector "InputMFSAnalysis"  --run_nr "1"  --wanted_samples "$WANTEDSAMPLES" --take_inputimage_off  --fr 0 --to 32
python -u detect_adversarials.py --net "cif10" --attack "std" --detector "InputMFSAnalysis" --wanted_samples "2000" --clf "RF" --num_classes 10  --run_nr "1" 



python -u extract_characteristics.py --net "cif10" --attack "std" --detector "InputMFSAnalysis"  --run_nr "1"  --wanted_samples "$WANTEDSAMPLES" --take_inputimage_off  --fr 8 --to 16
python -u detect_adversarials.py --net "cif10" --attack "std" --detector "InputMFSAnalysis" --wanted_samples "2000" --clf "RF" --num_classes 10  --run_nr "1" 



python -u extract_characteristics.py --net "cif10" --attack "std" --detector "InputMFSAnalysis"  --run_nr "1"  --wanted_samples "$WANTEDSAMPLES" --take_inputimage_off  --fr 8 --to 24
python -u detect_adversarials.py --net "cif10" --attack "std" --detector "InputMFSAnalysis" --wanted_samples "2000" --clf "RF" --num_classes 10  --run_nr "1" 



python -u extract_characteristics.py --net "cif10" --attack "std" --detector "InputMFSAnalysis"  --run_nr "1"  --wanted_samples "$WANTEDSAMPLES" --take_inputimage_off  --fr 8 --to 32
python -u detect_adversarials.py --net "cif10" --attack "std" --detector "InputMFSAnalysis" --wanted_samples "2000" --clf "RF" --num_classes 10  --run_nr "1" 


python -u extract_characteristics.py --net "cif10" --attack "std" --detector "InputMFSAnalysis"  --run_nr "1"  --wanted_samples "$WANTEDSAMPLES" --take_inputimage_off  --fr 16 --to 24
python -u detect_adversarials.py --net "cif10" --attack "std" --detector "InputMFSAnalysis" --wanted_samples "2000" --clf "RF" --num_classes 10  --run_nr "1" 

python -u extract_characteristics.py --net "cif10" --attack "std" --detector "InputMFSAnalysis"  --run_nr "1"  --wanted_samples "$WANTEDSAMPLES" --take_inputimage_off  --fr 16 --to 32
python -u detect_adversarials.py --net "cif10" --attack "std" --detector "InputMFSAnalysis" --wanted_samples "2000" --clf "RF" --num_classes 10  --run_nr "1" 

python -u extract_characteristics.py --net "cif10" --attack "std" --detector "InputMFSAnalysis"  --run_nr "1"  --wanted_samples "$WANTEDSAMPLES" --take_inputimage_off  --fr 24 --to 32
python -u detect_adversarials.py --net "cif10" --attack "std" --detector "InputMFSAnalysis" --wanted_samples "2000" --clf "RF" --num_classes 10  --run_nr "1" 
