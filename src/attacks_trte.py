...
if __name__ == '__main__':
    ...
    if args.wanted_samples_tr > 0:
        images, labels, images_advs, labels_advs = create_advs(logger, args, model, output_path_dir, clean_data_path, args.wanted_samples_tr, preprocessing, option=0)
    ...
    if args.wanted_samples_te > 0:
        ...
        images, labels, images_advs, labels_advs = create_advs(logger, args, model, output_path_dir, clean_data_path, args.wanted_samples_te, preprocessing, option=1)
