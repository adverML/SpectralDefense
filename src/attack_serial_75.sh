...
# python -u attack_imagenet32.py --net imagenet32 --num_classes 50 --attack fgsm
# python -u attack_imagenet32.py --net imagenet32 --num_classes 50 --attack bim
# python -u attack_imagenet32.py --net imagenet32 --num_classes 50 --attack pgd
# python -u attack_imagenet32.py --net imagenet32 --num_classes 50 --attack df
# python -u attack_imagenet32.py --net imagenet32 --num_classes 50 --attack cw
