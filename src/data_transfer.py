...
parser.add_argument("--net_eval",       default='imagenet32',     help=settings.HELP_NET)
...
# input data
extracted_characteristics_path = create_dir_extracted_characteristics(args, root='./data/extracted_characteristics/',  TRANSFER='data', wait_input=False)
