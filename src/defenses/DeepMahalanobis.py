...
# https://github.com/pokaxpoka/deep_Mahalanobis_detector/blob/90c2105e78c6f76a2801fc4c1cb1b84f4ff9af63/lib_generation.py#L45
...
def deep_mahalanobis(args, logger, model, images, images_advs, layers, get_layer_feature_maps, activation, output_path_dir):   
    ...
    if  args.net == 'mnist' or args.net == 'cif10' or args.net == 'cif10vgg' or args.net == 'cif10vggnew' or args.net == 'imagenet32' or args.net == 'celebaHQ32':
