...
def blackbox(args, images, images_advs, type=''):
    """
    Apply FFT on the input images
    mfs: magnitute
    pfs: phase
...
def calc_features(args, logger, model, images,  layers, get_layer_feature_maps, activation, typ='MFS'):
...
def whitebox_mfs_pfs(args, logger, model, images, images_advs, layers, get_layer_feature_maps, activation, typ='MFS'):
    ...
    mfs      = calc_features(args, logger, model, images,       layers, get_layer_feature_maps, activation, typ=typ)
    mfs_advs = calc_features(args, logger, model, images_advs,  layers, get_layer_feature_maps, activation, typ=typ)
