...
class SETTINGS:
    def __init__(self):
        ...
        self.DETECTOR_LIST_LAYERS = ['LayerMFS']
...
if __name__ == "__main__":
    ...
    for nr in NR:
        CSV_FILE_PATH.append( extract_information(settings, root='./data', net=['cif10vggnew'], dest='./data/detection',  nr=nr, csv_filename='cif10{}.csv'.format(APP), layers=LAYERS) )
