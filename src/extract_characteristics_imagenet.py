...
parser.add_argument("--net",      default='imagenet', help="the network used for the attack, either cif10 or cif100")
...
if attack_method == 'apgd-ce':
    # images =      torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/0.031373_1000_individ_apgd-ce_Linf_orig")
    # images_advs = torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/0.031373_1000_individ_apgd-ce_Linf_orig")
    images =      torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/apgd-ce_individ_0.03137_Linf_orig")
    images_advs = torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/apgd-ce_individ_0.03137_Linf_pert")

elif attack_method == 'apgd-t':
    images =      torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/apgd-t_individ_0.03137_Linf_orig")
    images_advs = torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/apgd-t_individ_0.03137_Linf_pert")
elif attack_method == 'fab-t':
    images =      torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/fab-t_individ_0.03137_Linf_orig")
    images_advs = torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/fab-t_individ_0.03137_Linf_pert")
elif attack_method == 'square':
    images =      torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/square_individ_0.03137_Linf_orig")
    images_advs = torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/ind/square_individ_0.03137_Linf_pert")
elif attack_method == 'std':

    if args.eps >= 0.03137254901960780:
        images_path =      "/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.031373_std_6000_Linf_sorted_orig"
        images_advs_path = "/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.031373_std_6000_Linf_sorted_pert"
        nr_samples = 6000
        ...
        images_path =      "/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.003922_std_6000_Linf_sorted_orig"
        images_advs_path = "/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.003922_std_6000_Linf_sorted_pert"
        nr_samples = 6000
    ...
    images = torch.load(images_path)[:1000]
    images_advs = torch.load(images_advs_path)[:1000]
    ...
    # # nr_img = 1000
    # if eps == 0.1:
    #     images =      torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.100000_std_Linf_sorted_orig")
    #     images_advs = torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.100000_std_Linf_sorted_pert")
    # elif eps == 8/255:
    #     images =      torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.031373_std_Linf_sorted_orig")
    #     images_advs = torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.031373_std_Linf_sorted_pert")
    # elif eps == 0.01:
    #     nr_img = 5000
    #     images =        torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.010000_std_5000_Linf_sorted_orig")
    #     images_advs =   torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.010000_std_5000_Linf_sorted_pert")
    #     # images =      torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.010000_std_Linf_sorted_orig")
    #     # images_advs = torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.010000_std_Linf_sorted_pert")
    # elif eps == 0.001:
    #     nr_img = 10000
    #     images =        torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.001000_std_10000_Linf_sorted_orig")
    #     images_advs =   torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.001000_std_10000_Linf_sorted_pert")
    #     # images =      torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.001000_std_Linf_sorted_orig")
    #     # images_advs = torch.load("/home/lorenzp/adversialml/src/pytorch-CelebAHQ/auto-attack/adv_complete_imagenet/std/0.001000_std_Linf_sorted_pert")
else:
    images =      torch.load('./data/'+net+'_adversarial_images/'+net+'_images_'+attack_method)[:1000]
    images_advs = torch.load('./data/'+net+'_adversarial_images/'+net+'_images_adv_'+attack_method)[:1000]
...
if net == 'imagenet':
    ...
    depth = 28
    widen_factor = 10
    model = WideResNet(num_classes=1000, block=WideBasic, depth=depth, widen_factor=widen_factor)
    if not NORMALIZED:
        checkpoint = torch.load('/home/lorenzp/adversialml/src/pytorch-CelebAHQ/autoattack/resnet_wide_orig.ckpt')
    else:
...
# np.save('./data/characteristics/0.03137/imagenet/'+net+'_'+attack_method+'_'+detector, characteristics)
# np.save('./data/characteristics/0.03137/imagenet/'+net+'_'+attack_method+'_'+detector, characteristics)
...
# np.save('./data/characteristics/std/' +net+'_'+attack_method+'_'+detector + '_gray_'  + '_eps_{:5f}'.format(eps),         characteristics)
# np.save('./data/characteristics/std/' +net+'_'+attack_method+'_'+detector + '_gray_'  + '_eps_{:5f}'.format(eps) +'_adv', characteristics_adv)

# filename = './data/characteristics/imagenet/std/' + net + '_' + attack_method + '_' + detector + '_{}_eps_{:5f}'.format(nr_samples, args.eps)
...
if attack_method == 'apgd-ce' or attack_method == 'apgd-t' or attack_method == 'fab-t' or attack_method == 'square':
    filename = './data/characteristics/0.03137/imagenet/ind/' + net + '_' + attack_method + '_' + detector
else:
    filename = './data/characteristics/imagenet/std/' + net + '_' + attack_method + '_' + detector + '_{}_eps_{:5f}'.format(nr_samples, args.eps)
if os.path.exists(filename + '.p'):
    os.remove(filename + '.p')
...
# save_img = './data/characteristics/std/' + net + '_' + attack_method  +'_' + detector + '_{}_gray_eps_{:5f}'.format(nr_img, eps)
# print(save_img)
# np.save(save_img, characteristics)
# np.save(save_img + '_adv', characteristics_adv)

# np.save('./data/characteristics/std/' +net+'_'+attack_method+'_'+detector + '_{}_' + '_eps_{:5f}'.format(nr_img, eps),         characteristics)
# np.save('./data/characteristics/std/' +net+'_'+attack_method+'_'+detector + '_{}_' + '_eps_{:5f}'.format(nr_img, eps) +'_adv', characteristics_adv)


# np.save('./data/characteristics/layers/'+net+'_'+attack_method+'_'+detector+'_'+layer_name[layer_nr]+'_adv', characteristics_adv)
# np.save('./data/characteristics/0.03137/imagenet/'+net+'_'+attack_method+'_'+detector+'_adv', characteristics_adv)
# np.save('./data/characteristics/0.03137/imagenet/'+net+'_'+attack_method+'_'+detector+'_adv', characteristics_adv)
